				...
				xhr.onreadystatechange = function () {
					if (this.readyState == 4 && this.status == 200) {
						...
						for(itr=0;itr<num;itr++){
							var obj = {name: ""+jsonObject[itr].FirstName+" "+jsonObject[itr].LastName, phone: jsonObject[itr].PhoneNumber, email: jsonObject[itr].Email, address: jsonObject[itr].Address}
